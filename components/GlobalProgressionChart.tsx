        ...
        <div className="space-y-1.5">
          {topPlayers.map((player: any, i: number) => (
            <div key={i} className="flex justify-between items-center">
              ...
              <span className="text-[10px] font-mono font-black text-white italic">{Math.round(player.elo)} / </span><span className="text-[10px] font-mono font-black italic text-purple-500">{Math.round(player.modern)}
              </span>
            </div>
          ))}
        </div>
