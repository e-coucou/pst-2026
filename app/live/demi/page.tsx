      ...
      <div className="max-w-5xl mx-auto">
        ...
        {allFinished && (
          <div className="mb-12 p-6 rounded-[2rem] bg-red-600 flex flex-col md:flex-row items-center justify-between gap-4 shadow-[0_0_40px_rgba(220,38,38,0.3)]">
            ...
            <button className="w-full md:w-auto bg-black text-white px-8 py-3 rounded-xl font-black uppercase text-sm tracking-tighter hover:bg-white hover:text-black transition-all">
              Générer les Finales
            </button>
          </div>
        )}
