...
import { ArrowLeft, Loader2, Search, Home, Boxes, Warehouse, DoorClosed, Archive, Layers, Box as BoxIcon } from 'lucide-react';

type Categorie = 'studio' | 'appartement' | 'box' | 'cave' | 'chambre_de_bonne' | 'placard';
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="mb-8">
          <h1 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter">
            Lots <span className="text-red-600">Bâtiment B</span>
          </h1>
        ...
        <div className="flex items-center gap-2 flex-wrap mb-4">
          ...
          {CATEGORIES.map(cat => (
            ...
            >
              {cat.icon} {cat.label} ({lots.filter(l => l.categorie === cat.value).length})
            </button>
          ))}
        </div>
        ...
        <div className="relative mb-8">
          ...
          <input placeholder="Rechercher (ex: B12, Box 11, 66...)" value={search} onChange={e => setSearch(e.target.value)}
