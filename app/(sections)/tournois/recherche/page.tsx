...
export default async function MatchSearchPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-12 space-y-8 bg-black text-white min-h-screen">
      <Link href="/tournois" className="inline-flex items-center gap-2 text-zinc-400 hover:text-red-600 transition-colors text-xs font-black uppercase tracking-widest">
        <ChevronLeft size={16} /> Tournois
      </Link>
