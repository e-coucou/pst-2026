...
import { Film, Calendar, ExternalLink, Heart, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 md:p-20">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <Link href="/videos" className="inline-flex items-center gap-2 text-white bg-zinc-900 hover:bg-red-600 border border-white/10 hover:border-red-600 transition-all px-5 py-3 rounded-full text-xs font-black uppercase tracking-widest mb-10 active:scale-95">
        ...
        <div className="mb-16 text-center flex flex-col items-center">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-red-600 font-black uppercase tracking-[0.3em] text-xs">Galerie Vidéos</span>
          </div>
