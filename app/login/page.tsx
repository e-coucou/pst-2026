  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-6 text-white font-sans">
      <div className="max-w-md w-full">
        {message && <div className="mb-6 bg-green-500/10 border border-green-500/20 p-4 rounded-2xl text-green-500 text-center text-xs font-bold uppercase tracking-widest">{message}</div>}
        ...
        <div className="bg-zinc-900/50 border border-white/10 p-10 rounded-[3rem] shadow-2xl backdrop-blur-xl">
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl font-black uppercase italic tracking-tighter">PST <span className="text-red-600 italic">Club</span></h1>
            <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.2em] mt-2 italic">Espace Membres</p>
          </div>
